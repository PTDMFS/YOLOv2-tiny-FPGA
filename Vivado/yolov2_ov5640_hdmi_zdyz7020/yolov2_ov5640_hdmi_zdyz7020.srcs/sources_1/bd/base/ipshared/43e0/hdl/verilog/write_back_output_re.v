...
wire   [27:0] ret_V_fu_802_p2;
reg   [27:0] ret_V_reg_937;
(* use_dsp48 = "no" *) wire   [27:0] ret_V_3_fu_569_p2;
reg   [27:0] ret_V_3_reg_942;
...
wire   [13:0] OutputOffset_cast_fu_636_p1;
reg   [13:0] OutputOffset_cast_reg_979;
wire   [28:0] OutputOffset3_cast_fu_647_p1;
reg   [28:0] OutputOffset3_cast_reg_984;
wire   [7:0] tmp_fu_651_p3;
reg   [7:0] tmp_reg_990;
wire   [4:0] mLoop_1_fu_659_p3;
reg   [4:0] mLoop_1_reg_996;
wire   [4:0] rLoop_cast4_cast_fu_666_p3;
reg   [4:0] rLoop_cast4_cast_reg_1001;
...
reg   [28:0] OutputOffset1_sum1_reg_300;
reg   [28:0] OutputOffset1_sum_reg_310;
reg   [4:0] tm_reg_320;
reg   [13:0] OutputOffset2_sum_reg_332;
...
wire   [8:0] OutputOffset_fu_629_p3;
wire   [17:0] OutputOffset3_fu_640_p3;
wire   [4:0] mLoop_3_fu_626_p1;
wire   [17:0] ret_V_fu_802_p0;
wire   [9:0] ret_V_fu_802_p1;
...
wire   [27:0] ret_V_fu_802_p00;
wire   [27:0] ret_V_fu_802_p10;
...
outputpixel2buf grp_outputpixel2buf_fu_367(
    ...
    .OutputOffset1_sum(OutputOffset1_sum_reg_310),
    .OutputOffset1_sum1(OutputOffset1_sum1_reg_300),
    .OutputOffset2_sum(OutputOffset2_sum_reg_332),
...
mmcpy_outputpixel grp_mmcpy_outputpixel_fu_463(
    ...
    .OutputLength(tmp_reg_990),
    .OutputLength1(tmp_reg_990),
...
YOLO2_FPGA_mul_mueQU_U1075(
    .din0(ret_V_fu_802_p0),
    .din1(ret_V_fu_802_p1),
    .dout(ret_V_fu_802_p2)
);
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_693_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
        OutputOffset1_sum1_reg_300 <= OutputOffset1_sum1_1_fu_752_p2;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        OutputOffset1_sum1_reg_300 <= grp_fu_816_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_fu_693_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
        OutputOffset1_sum_reg_310 <= OutputOffset1_sum_1_fu_747_p2;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        OutputOffset1_sum_reg_310 <= OutputOffset1_sum_3_s_fu_612_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((write_flag_read_read_fu_240_p2 == 1'd1) & (exitcond1_fu_682_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        OutputOffset2_sum_reg_332 <= 14'd0;
    end else if (((1'b0 == ap_block_state6_on_subcall_done) & (1'b1 == ap_CS_fsm_state6))) begin
        OutputOffset2_sum_reg_332 <= OutputOffset2_sum_1_fu_787_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        OutputOffset3_cast_reg_984[17 : 0] <= OutputOffset3_cast_fu_647_p1[17 : 0];
        OutputOffset_cast_reg_979[8 : 0] <= OutputOffset_cast_fu_636_p1[8 : 0];
        TC_MINe26_reg_969 <= TC_MINe26_fu_615_p2;
        mLoop_1_reg_996 <= mLoop_1_fu_659_p3;
        rLoop_cast4_cast_reg_1001[1 : 0] <= rLoop_cast4_cast_fu_666_p3[1 : 0];
rLoop_cast4_cast_reg_1001[4 : 3] <= rLoop_cast4_cast_fu_666_p3[4 : 3];
        tmp_2_cast3_cast_reg_1006[0] <= tmp_2_cast3_cast_fu_674_p3[0];
tmp_2_cast3_cast_reg_1006[4 : 3] <= tmp_2_cast3_cast_fu_674_p3[4 : 3];
        tmp_reg_990[2] <= tmp_fu_651_p3[2];
tmp_reg_990[5] <= tmp_fu_651_p3[5];
tmp_reg_990[7] <= tmp_fu_651_p3[7];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        ret_V_3_reg_942 <= ret_V_3_fu_569_p2;
    end
end
...
assign OutputOffset1_sum1_1_fu_752_p2 = (OutputOffset3_cast_reg_984 + OutputOffset1_sum1_reg_300);

assign OutputOffset1_sum_1_fu_747_p2 = (OutputOffset3_cast_reg_984 + OutputOffset1_sum_reg_310);

assign OutputOffset1_sum_3_s_fu_612_p1 = ret_V_3_reg_942;

assign OutputOffset2_sum_1_fu_787_p2 = (OutputOffset_cast_reg_979 + OutputOffset2_sum_reg_332);

assign OutputOffset3_cast_fu_647_p1 = OutputOffset3_fu_640_p3;

assign OutputOffset3_fu_640_p3 = ((TC_MINe26_fu_615_p2[0:0] === 1'b1) ? OHxOW : 18'd338);

assign OutputOffset_cast_fu_636_p1 = OutputOffset_fu_629_p3;

assign OutputOffset_fu_629_p3 = ((TC_MINe26_fu_615_p2[0:0] === 1'b1) ? Output_w_9b_V_reg_921 : 9'd0);
...
assign exitcond1_fu_682_p2 = ((tm_reg_320 == mLoop_1_reg_996) ? 1'b1 : 1'b0);

assign exitcond_fu_693_p2 = ((tr_reg_344 == tmp_2_cast3_cast_reg_1006) ? 1'b1 : 1'b0);

assign grp_fu_487_p2 = ((tr_reg_344 != 5'd0) ? 1'b1 : 1'b0);
...
assign grp_fu_816_p20 = ret_V_3_reg_942;
...
assign mLoop_1_fu_659_p3 = ((TC_MINe26_fu_615_p2[0:0] === 1'b1) ? mLoop1_V_reg_947 : mLoop_3_fu_626_p1);
...
assign rLoop_cast4_cast_fu_666_p3 = ((TC_MINe26_fu_615_p2[0:0] === 1'b1) ? 5'd26 : 5'd1);

assign r_9b_V_fu_518_p1 = r[8:0];

assign ret_V_3_fu_569_p2 = (grp_fu_808_p3 + rhs_V_3_cast_fu_566_p1);

assign ret_V_fu_802_p0 = ret_V_fu_802_p00;

assign ret_V_fu_802_p00 = OHxOW;

assign ret_V_fu_802_p1 = ret_V_fu_802_p10;

assign ret_V_fu_802_p10 = m_10b_V_fu_514_p1;

assign rhs_V_3_cast_fu_566_p1 = c_9b_V_reg_932;

assign tm_1_fu_687_p2 = (tm_reg_320 + 5'd1);
...
assign tmp_5_fu_707_p2 = ((tr_reg_344 != rLoop_cast4_cast_reg_1001) ? 1'b1 : 1'b0);

assign tmp_8_fu_544_p2 = ((TM_MIN_6b_V_reg_915 == 6'd9) ? 1'b1 : 1'b0);

assign tmp_fu_651_p3 = ((TC_MINe26_fu_615_p2[0:0] === 1'b1) ? 8'd13 : 8'd169);

assign tr_1_fu_698_p2 = (tr_reg_344 + 5'd1);

assign write_flag_read_read_fu_240_p2 = write_flag;

always @ (posedge ap_clk) begin
    OutputOffset_cast_reg_979[13:9] <= 5'b00000;
    OutputOffset3_cast_reg_984[28:18] <= 11'b00000000000;
    tmp_reg_990[1:0] <= 2'b01;
    tmp_reg_990[4:3] <= 2'b01;
    tmp_reg_990[6] <= 1'b0;
    rLoop_cast4_cast_reg_1001[2] <= 1'b0;
