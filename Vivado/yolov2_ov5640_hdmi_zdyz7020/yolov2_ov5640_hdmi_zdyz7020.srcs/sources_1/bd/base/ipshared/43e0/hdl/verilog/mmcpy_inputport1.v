...
wire   [0:0] enable_fu_146_p2;
wire   [31:0] sum_fu_156_p2;
reg   [31:0] sum_reg_202;
reg    ap_sig_ioackin_m_axi_input_r_ARREADY;
wire   [0:0] exitcond_fu_176_p2;
reg   [0:0] exitcond_reg_218_pp0_iter1_reg;
wire   [5:0] indvar_next_fu_181_p2;
reg   [5:0] indvar_next_reg_222;
reg    ap_enable_reg_pp0_iter0;
reg   [31:0] input_addr_read_reg_227;
wire    ap_CS_fsm_state8;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state9;
reg    ap_enable_reg_pp0_iter2;
reg   [5:0] ap_phi_mux_indvar_phi_fu_124_p4;
wire   [63:0] indvar1_fu_187_p1;
wire  signed [63:0] sum_cast_fu_162_p1;
reg    ap_reg_ioackin_m_axi_input_r_ARREADY;
wire   [1:0] tmp_fu_136_p4;
wire  signed [31:0] tmp_cast_fu_152_p1;
...
always @ (posedge ap_clk) begin
    if (((exitcond_reg_218 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        indvar_reg_120 <= indvar_next_reg_222;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        indvar_reg_120 <= 6'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        exitcond_reg_218 <= exitcond_fu_176_p2;
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        indvar_next_reg_222 <= indvar_next_fu_181_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_reg_218 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        input_addr_read_reg_227 <= m_axi_input_r_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((enable_fu_146_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
...
always @ (*) begin
    if (((exitcond_reg_218 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
        ap_phi_mux_indvar_phi_fu_124_p4 = indvar_next_reg_222;
    end else begin
...
always @ (*) begin
    if (((exitcond_reg_218_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1) & (enable_fu_146_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state12;
            end else if (((enable_fu_146_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_fu_176_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_fu_176_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_state12;
            end else begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((exitcond_reg_218 == 1'd0) & (m_axi_input_r_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((exitcond_reg_218 == 1'd0) & (m_axi_input_r_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_state10_pp0_stage0_iter1 = ((exitcond_reg_218 == 1'd0) & (m_axi_input_r_RVALID == 1'b0));
end
...
assign enable_fu_146_p2 = ((tmp_fu_136_p4 == 2'd0) ? 1'b1 : 1'b0);

assign exitcond_fu_176_p2 = ((ap_phi_mux_indvar_phi_fu_124_p4 == RowIntNum) ? 1'b1 : 1'b0);

assign indvar1_fu_187_p1 = indvar_reg_120_pp0_iter1_reg;

assign indvar_next_fu_181_p2 = (ap_phi_mux_indvar_phi_fu_124_p4 + 6'd1);

assign input_memcpy_buffer_address0 = indvar1_fu_187_p1;

assign input_memcpy_buffer_d0 = input_addr_read_reg_227;

assign input_offset_cast_fu_132_p1 = input_offset;

assign m_axi_input_r_ARADDR = sum_cast_fu_162_p1;
...
assign sum_cast_fu_162_p1 = $signed(sum_reg_202);

assign sum_fu_156_p2 = ($signed(tmp_cast_fu_152_p1) + $signed(input_offset_cast_fu_132_p1));

assign tmp_cast_fu_152_p1 = $signed(RowOffset);

assign tmp_fu_136_p4 = {{TN_MIN_V[2:1]}};

endmodule //mmcpy_inputport1
