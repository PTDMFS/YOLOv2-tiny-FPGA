...
/////////////////////////////////////////////////////////////////////////
	...
	float *Weight_buf = (float *)calloc(54343360/4,sizeof(float));
	float *Beta_buf   = (float *)calloc(13924/4,sizeof(float));
	...
	fread(Weight_buf, sizeof(float), 54343360/4, fp_w);
	fread(Beta_buf, sizeof(float), 13924/4, fp_b);
...
////////////////////////////////////////////////////////////////////
	...
	{
		tmp_ptr_ft32[i] = ((short)(input[i]*pow(2.0,11)))*pow(2.0,-11);
	}
	float *inout_fixed_buf = (float *)calloc(sizeof(float),416*416*32); 
	io_maxQarray[0] = 11;//1st layer input Q14
//////////////////////////////////////////////////////////////
